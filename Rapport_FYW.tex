...
\begin{document}
  ...
  \begin{abstract}
    ...
    Finally this document explains the project phase within the Innov' cell of Aubay
  ...
  \section{Conclusion}
    ...
    \subsection{Le bilan technique}
      ...
      J'ai renforcées mes connaissances sur la créations de scripts shell sur Linux afin d'automatiser l'installation d'un ensemble de 
      fichiers nécéssaires au lancement d'un projet, mais aussi sur le debbugage d'erreurs d'installations multiples.
      ...
      nous permettant de nous affranchir des différences de système d'exploitation et de langages de programmation. 
      
      J'ai également développé une application graphique pour la première fois, ce qui m'a beaucoup appris sur des framework de 
      developpement d'applications tels que Flutter et PyQt5, ce développement m'a beaucoup appris sur les notions liées 
      à la communication entre l'affichage graphique et les fonctions sous-jacentes d'une application web ou bureau.

      Cette expérience est venu compléter les compétences en développement que j'ai pu acquérir lors de mon cursus à l'ESIEA. En
      effet, c'est lors de divers projets d'école que j'ai appris le développement en C++ et Python qui m'ont servis lors de cette 
    ...
    \subsection{Le bilan humain}
      ...
      autres écoles. J'ai eu des échanges très riches avec mes collègues stagiaires direct et aussi avec les stgiaires travaillant 
    ...
    \subsection{Possibilités d'évolution du projet}
      ...
      compléter la notre (comme la publication parlant de DGS avec le SegNet qui enlève les objets dynamiques du traîtement).
    ...
    \subsection{Perspectives d'évolution professionnelles}
      ...
      Le but va être de me former et de monter en compétences en Cloud (AWS) qui devient nécéssaire dans 
  ...
  \section{Annexes}
    ...
    \subsection{Communication}    
      ...
      \begin{figure}[hbt]  
        ...
        \caption{Schéma d'intéractions du projet.}
        \label{fig:Schema2}
      \end{figure}
