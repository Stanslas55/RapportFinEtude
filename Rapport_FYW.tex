...
\usepackage[hmargin={3.3cm,3.3cm}, top=3.0cm,bottom=3.0cm]{geometry} 
...
\begin{document}
  ...
  \section{Introduction et contexte}      
    ...
    Selon son site internet, Aubay est implantée dans 7 pays européens, et a réalisé un chiffre d'affaires de 470,6 M€ en 2021. 
    ...
    La prise en main du projet a démarré début février, s'en est suivi la partie concernant les états de l'art (\acrshort{ea} sur la Figure \ref{fig:Planning}) 
    ...
    \subsection{Recherches bibliographiques}
      ...
      concept. Je présente ici 4 des publications les plus pertinentes sur le sujet.
        ...
        \subsubsection{Wearable Travel Aid for Environment Perception and Navigation of Visually Impaired People}
          ...
          se sert des informations récupérées pour trianguler la position 3D du module. 
  ...
  \section{Les dimensions techniques du projet}
    \subsection{Phase de preuve de concept}
      ...
      La preuve de concept (\acrshort{poc}) sur laquelle j'ai travaillé avec mon équipe, se concentrait sur la création d'une carte locale de l'environnement, en nous basant sur des points d'intérêts (\acrshort{poi}) entre les images vues successivement, c'est la méthode SLAM. Dans cette partie j'ai beaucoup travaillé sur la recherche de solutions concernant les problèmes de version, sur l'installation au niveau de la machine virtuelle ainsi que l'ajout du module de recherche du plus court chemin dans l'écosystème ORB-SLAM3.
      \subsubsection{Installation}
        ...
        puis j'ai proposé d'écrire un script contenant ces commandes afin d'automatiser notre installation. Il a souvent été nécessaire de définir de nouvelles variables d'environnement
        ...
        qui écrivait dans le fichier \textit{.bashrc} de notre système, fichier exécuté à chaque lancement du système. 
        ...
        \paragraph{Général}
          ...
          application. J'ai alors proposé de basculer sur un système Ubuntu 20.04 sur VM afin de disposer des fonctionnalités de base
          nécessaires à notre avancée. Ayant beaucoup travaillé sur des machines virtuelles lors de ma formation, j'étais à l'aise avec cet outil qui était assez méconnu de mes collègues, je suis donc devenu le référent en matière de machines virtuelles.

        \paragraph{Eigen}
          Eigen est une bibliothèque d'algèbre linéaire, elle traite les vecteurs, matrices, solveurs numériques et les algorithmes
          associés. Cette bibliothèque est nécessaire au bon fonctionnement d'ORB-SLAM3. Pour l'installer, nous avons dû chercher la version adaptée puisque la bibliothèque a évolué depuis la publication du dépôt Github d'ORB-SLAM3, rendant les versions les plus récentes
      ...
      \subsubsection{Recherche de chemin}
        ...
        \paragraph{L'algorithme A*}
          ...
          \begin{itemize}
            ...
            \item F = G + H            
          \end{itemize} 
          A* base sa décision sur la valeur de F, il cherche toujours à minimiser cette valeur jusqu'à atteindre sa destination,
    ...
    \subsection{Phase projet}
      ...
      à des personnes malvoyantes, ne nécessitant qu'une interface vocale. Pour cette partie, j'ai pris la direction du développement de l'interface graphique.
      ...
      \subsubsection{Développement de l'application}      
        ...
        lançant le serveur Flask, le POC SLAM, CV et NLP, sont appelés. La caméra s'allume et le flux vidéo est transmis aux POCs SLAM et CV pour commencer leur
        ...
        caméra sont montrées à l'utilisateur sur la partie centrale de l'application. CV fournis aussi une carte 2D des obstacles détectés, c'est la carte en haut
        ...
        l'objet, par exemple: "bouteille", "chaise" ou encore "porte", puis il se fera guider grâce au module CV quand ce dernier aura détecté l'objet recherché dans 
        le champ de vision de la caméra. Une autre commande possible est de demander la sauvegarde d'une position, via le module SLAM, en prononçant 
        ...
        perturber l'exécution normale de ces programmes) dans les POCs afin de récupérer les informations nécessaires à l'affichage graphique.
  ...
  \section{Les dimensions humaines et managériales} 
    \subsection{Le plan humain}
      ...
      matérialisé sous la forme d'un open space dans lequel plusieurs équipes travaillaient sur des projets 
      différents. Cela permettait sur les temps de pause de créer du lien autour des différents endroits 
      ...
      a pu recommencer à organiser des évènements de rencontres après les heures de travail. Ces moments de convivialité 
