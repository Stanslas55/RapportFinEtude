  ...
  \section{Les dimensions techniques du projet (8 à 12 p)}
    ...
    \subsection{Phase projet}
      ...
      \subsubsection{Développement de l'application}
        Création d'une maquête de l'application

        Décision du framework à utiliser: Aubay nous a proposé de choisir entre Angular et Flutter mais l'idée était aussi de découvrir 
        une nouvelle technologies. Nous avons opté pour le Flutter puisque j'avais déjà été confronté à cette technologie lors d'un projet
        personnel.   



        
        Après 2 semaines de travail, nous nous sommes rendu compte que Flutter ne répondait pas à certains de nos besoin techniques
        tels que l'affichage d'images successivement en temps réel, les temps de communications étaient trop long et il était compliqué 
        d'executer des scripts python depuis l'application développée en Flutter.


        Passage à PyQt5 afin de développer une interface rapidement et facilement, le but était de faciliter la communication avec le 
        backend pour permettre du temps réel.
