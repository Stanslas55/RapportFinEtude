...
\begin{document}
  ...
  \section{État de l'art}  
    ...
    \subsection{Recherches bibliographiques}
      ...
      concept. Je présente ici 4 des publications les plus pertinentes sur le sujet.
        ...
        \subsubsection{ORB-SLAM3: An Accurate Open-Source Library for Visual, Visual-Inertial and Multi-Map SLAM}
          ...
          ORB-SLAM3 introduit l'utilisation de mémoire à court, moyen et long terme regroupées dans un Atlas.
    ...
    \pagebreak
  % TODO: Supprimer la consigne + indication de pages.
    ...
    \subsection{Phase de preuve de concept}
      ...
      \subsubsection{Installation}
        ...
        \paragraph{General}
          ...
          l'installer et la faire fonctionner puis ajouter les fonctionnalitées nécéssaires à notre POC. Ce projet open-source a été
...
% TODO: Relire la phase projet.
    \subsection{Phase projet}
      Une fois la phase de POC terminée, nous devions passer à la phase projet nécéssitant d'associer nos POCs
      ...
      afin de montrer à la direction générale ainsi qu'aux directeurs commerciaux ce dont les stagiaires sont capable et ce qu'Aubay pourrait
      ...
      \subsubsection{Protocole de communication}
        ...
        sont développés en Python sur Windows. Le problème étant que WSL2 ne nous permettait pas d'accéder au flux vidéo de la caméra nécéssaire 
        aux POCs SLAM et CV, qu'une VM nous le permettait mais ne donnait pas accès aux unitées de traitement graphiques (GPU) nécéssaires aux 
        POCs CV et NLP. Nous avons optés pour 
        ...
        vidéo de Windows à WSL2. Cette solution a nécéssité d'adapter la manière dont ORB-SLAM3 récuperait le flux vidéo avant de l'incorporer à 
        ...
        afin d'executer les fonctions utiles au bon moment. Un schéma global des communications établies au sein du projet est disponible en 
        annexe.

        % TODO: Mettre le schéma de Victor concernant la communication en annexe.
  ...
  % TODO: Dimension humaine et managériales.
  ...
  \section{Annexes}
    ...
    \subsection{Point d'intéret}
      ...
      si deux objets avec un point de vue différent sont les même ou non. Les méthodes d'extractions de POI les plus populaires 
