...
\usepackage[hmargin={3.0cm,3.0cm}, top=3.0cm,bottom=3.0cm]{geometry} 
      ...
      concept. Je présente ici 4 des publications les plus pertinentes sur le sujet.
        ...
        \subsubsection{CDSFusion: Dense Semantic SLAM for Indoor Environment Using CPU Computing}
          ...
          \paragraph{Le module de segmentation sémantique}
            ...
            régions de l'image puis aggrège le tout. Les déductions locales accolées avec les déductions sur l'image globale produisent une prédiction
            finale plus fiable.
