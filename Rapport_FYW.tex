...
\begin{document}
  ...
  \section{Les dimensions techniques du projet (8 à 12 p)}
    ...
    \subsection{Recherche de chemin}
      ...
      \subsubsection{Matrice de coordonnées}

      \subsubsection{Structures de données définies}

        \paragraph{Coord}

        \paragraph{AbsoluteCoord}

        \paragraph{Path}        

      \subsubsection{Instances utilisées}

        \paragraph{LocalPath}     
        
        \paragraph{Absolute2DCoordinates}   

        \paragraph{PoiList}   

      \subsubsection{L'algorithme A*}

      \subsubsection{Retourner à un point d'intérêt}

      \subsubsection{FYWBack}
    ...
    \subsection{Phase projet}
      ...
      Passage à PyQt5
      Réalisation des liens entre Frontend et Backend 
